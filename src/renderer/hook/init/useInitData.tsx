...
import { QuickReplyAllDtoGraphql } from 'renderer/domain/Chat';
import { QUERY_QUICK_REPLY } from 'renderer/domain/graphql/QuickReply';
import { setQuickReply } from 'renderer/state/chat/chatAction';
import {
