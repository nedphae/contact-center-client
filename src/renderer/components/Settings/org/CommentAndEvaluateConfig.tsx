...
export default function CommentAndEvaluateConfig(
  ...
  const caeJsonText =
    configJson?.value ??
    '{"comment":{"title":"留言","nameText":"姓名","mobileText":"手机","emailText":"邮箱","messageText":"留言","placeholder":"请输入...","cancleBtnText":"取消","submitBtnText":"提交","successMsg":"留言提交成功","failMsg":"姓名 留言 不能为空, 手机/邮箱 请至少填写一项"},"evaluate":{"title":"评价","evaluationOptionsText":"满意度","evaluationOptions":{"eval_100":"非常满意","eval_75":"满意","eval_50":"一般","eval_25":"不满意","eval_1":"非常不满意"},"userResolvedOptions":{"status_1":"已解决","status_2":"未解决"},"evaluationRemarkText":"评价内容","userResolvedStatusText":"解决状态","placeholder":"请输入...","cancleBtnText":"取消","submitBtnText":"提交","thanks":"谢谢您的评价"}}';

  const caeJson = JSON.parse(caeJsonText) as CommentAndEvaluateConfigType;

  const { handleSubmit, register } = useForm<CommentAndEvaluateConfigType>({
