...
export default function FixedPlugin(props: { bgImage: any; handleFixedClick: () => void; rtlActive: any; fixedClasses: string | undefined; bgColor: string; handleColorClick: (arg0: string) => void; handleImageClick: (arg0: string) => void; }) {
