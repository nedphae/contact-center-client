 ...
 */
function getTextValue(key: string, defaultValue: string = ''): string {
...
// 检查 value 类型
function isValidCodon(value: string): value is keyof typeof config.theme {
    return value in config.theme;
}
