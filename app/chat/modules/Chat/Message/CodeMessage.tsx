...
function isValidCodon(lan: string): lan is keyof typeof languagesMap {
    return lan in languagesMap;
}
...
function CodeMessage(props: CodeMessageProps) {
    ...
    const language = isValidCodon(parseResult[1]) ? languagesMap[parseResult[1]] : 'text';
