...
function MessageList() {
    ...
    const $list = useRef<{ scrollHeight: number, clientHeight: number, scrollTop: number }>(null);

    let isFetching = false;
    async function handleScroll(e: { target: { scrollHeight: number; clientHeight: number; scrollTop: number; }; }) {
    ...
    return (
        <div className={`${Style.messageList} show-scrollbar`} onScroll={handleScroll as any} ref={$list as any}>
