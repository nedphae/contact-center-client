...
function MessageList() {
  ...
  const isGroup = useSelector(
    (state: RootState) => state.chat.linkmans[focus].type === 'group'
  );
  const creator = useSelector(
    (state: RootState) => state.chat.linkmans[focus].creator
  );
  const messages = useSelector(
    (state: RootState) => state.chat.linkmans[focus].messages
  );
