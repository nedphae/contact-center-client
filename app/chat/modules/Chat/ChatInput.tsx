...
function ChatInput() {
  ...
  const connect = useSelector((state: RootState) => state.chat.connect);
  const selfId = useSelector((state: RootState) => state.chat.user?._id);
  const username = useSelector((state: RootState) => state.chat.user?.username);
  const avatar = useSelector((state: RootState) => state.chat.user?.avatar);
  const tag = useSelector((state: RootState) => state.chat.user?.tag);
  const focus = useSelector((state: RootState) => state.chat.focus);
  const linkman = useSelector((state: RootState) => state.chat.linkmans[focus]);
  ...
  function handleFeatureMenuClick(e: { key: string; domEvent: any }) {
  ...
  function replaceAt(targetUsername: any) {
