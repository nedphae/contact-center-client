...
function ChatInput() {
    ...
    async function handlePaste(e: { preventDefault: () => void; clipboardData: any; originalEvent: { clipboardData: any; }; }) {
        // eslint-disable-next-line react/destructuring-assignment
        if (!connect) {
            e.preventDefault();
            return Message.error('发送消息失败, 您当前处于离线状态');
    ...
    async function handleInputKeyDown(e: { key: any; preventDefault?: any; altKey?: any; }) {
        if (e.key === 'Tab') {
            e.preventDefault();
