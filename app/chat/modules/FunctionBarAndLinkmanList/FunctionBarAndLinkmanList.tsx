    ...
    return (
        <div className={Style.functionBarAndLinkmanList} onClick={handleClick} role="button">
            <div className={Style.container} {...aero}>
                ...
                >
                    <Tab style={style} icon={<ChatIcon />} aria-label="phone" {...a11yProps(0)} />
                    <Tab style={style} icon={<HistoryIcon />} aria-label="favorite" {...a11yProps(1)} />
                    <Tab style={style} icon={<PeopleAltIcon />} aria-label="person" {...a11yProps(2)} />
                </Tabs>
                <TabPanel value={value} index={0}>
                    <LinkmanList />
                </TabPanel>
                <TabPanel value={value} index={1}>
                    <LinkmanList history = {true} />
                </TabPanel>
