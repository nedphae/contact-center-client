...
function SelfInfo(props: SelfInfoProps) {
    ...
    function handleChangeAvatar() {
        $cropper.current.getCroppedCanvas().toBlob(async (blob: Blob) => {
    ...
    function handleCloseDialog(event: { target: { className: string; }; }) {
        /**
    ...
    return (
        <Dialog className={Style.selfInfo} visible={visible} title="个人信息设置" onClose={handleCloseDialog as any}>
