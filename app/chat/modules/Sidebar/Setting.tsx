...
function Setting(props: SettingProps) {
    ...
    function setTheme(themeName: "default" | "cool") {
    ...
    function handlePrimaryColorChange(color: { rgb: { r: any; g: any; b: any; }; }) {
    ...
    function handlePrimaryTextColorChange(color: { rgb: { r: any; g: any; b: any; }; }) {
                        ...
                        <div className={Common.block}>
                            <div>
                                <RadioGroup
                                    className={Style.TagModeRadioGroup}
                                    value={theme}
                                    onChange={(newValue: "default" | "cool") => setTheme(newValue)}
                                    horizontal
                                >
                                    <RadioButton value="default">默认</RadioButton>
